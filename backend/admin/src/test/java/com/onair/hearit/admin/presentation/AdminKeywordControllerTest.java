...
import com.onair.hearit.dto.request.KeywordCreateRequest;
import com.onair.hearit.dto.request.KeywordUpdateRequest;
import com.onair.hearit.dto.response.AdminKeywordResponse;
...
class AdminKeywordControllerTest extends IntegrationTest {
    ...
    void getPagedKeywords() {
        ...
        // when
        AdminPagedResponse<AdminKeywordResponse> response = RestAssured.given().log().all()
