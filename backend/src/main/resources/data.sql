...
INSERT INTO hearit (id,
                    ...
                    category_id)
VALUES (1,
        '사나, 수양의 웹 세계 문지기 HTTP와 HTTPS 부수기!',
        ...
        1),
       (2,
        '비비의 Activity LifeCycle',
        '/hearit/audio/original/ORG_39181115-ae25-460a-809e-e974cb74ce78.mp3',
        '/hearit/audio/short/SHT_39181115-ae25-460a-809e-e974cb74ce78.mp3',
        '/hearit/script/SCR_39181115-ae25-460a-809e-e974cb74ce78.json',
        '우아한 테크 - 테코톡',
        '안드로이드 4대 컴포넌트 중 하나인 Activity의 생성부터 소멸까지의 흐름, 즉 Activity LifeCycle을 자세히 알아봅니다.',
        451, '2025-07-17 16:55:25',
        2),
       (3,
        '슬링키의 직렬화, 역직렬화 in Spring',
        '/hearit/audio/original/ORG_43740a20-a6bb-4815-9aae-5cf8f33c07eb.mp3',
        '/hearit/audio/short/SHR_43740a20-a6bb-4815-9aae-5cf8f33c07eb.mp3',
        '/hearit/script/SCR_43740a20-a6bb-4815-9aae-5cf8f33c07eb.json',
        '우아한 테크 - 테코톡',
